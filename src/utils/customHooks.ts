  ...
  useEffect(() => {
    ...
    const ws = WaveSurfer.create({
      ...
      renderFunction: (channels, ctx) => {
        ...
        const topPartHeight = height * 0.65;
        const bottomPartHeight = height * 0.35;
        ...
        for (let i = 0; i < barCount; i++) {
          ...
          ctx.rect(i * (barWidth + barGap), yBottom + (barHeight * bottomPartHeight + 1), barWidth, barHeight * bottomPartHeight);
